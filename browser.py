...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About LightBrowser", self)
        about_action.setStatusTip("More info about LightBrowser")  # Hungry!
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_mozarella_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')),
                                            "LightBrowser Homepage", self)
        navigate_mozarella_action.setStatusTip("Go to LightBrowser Homepage")
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle("%s - Lightbrowser" % title)

    def navigate_mozarella(self):
        self.tabs.currentWidget().setUrl(QUrl("https://www.duckduckgo.com/522076"))
...
app.setApplicationName("lightbrowser")
app.setOrganizationName("lightbrowser")
app.setOrganizationDomain("i don't have one yet")
